...
CREATE TABLE `layoffs_staging2` (
  ...
  `row_num` int
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci; -- Craeting a separate table to remove duplicates
...
drop column row_num; -- Dropping row_num column since no further use
...
where country like 'United States%'; -- All countries similar to 'Uni
